    ...
    <div className="mt-10 pb-10 border-t pt-5">
      ...
      <div className="grid min-h-96 items-start grid-cols-12 gap-x-5 mt-5">
        ...
        <img
          ...
          src="https://plus.unsplash.com/premium_photo-1664382465820-fdc7544548f2?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
        />
      </div>
      <div className="flex mt-5 text-white gap-x-5">
        <Link
          target="_blank"
          href={"https://www.youtube.com/@omegainstitute/videos"}
        >
          Youtube
        </Link>
        <Link
