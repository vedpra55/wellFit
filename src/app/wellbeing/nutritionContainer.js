   ...
   async  function main() {
    ...
    return (
        ...
        <div className="grid min-h-96 items-start grid-cols-12 gap-x-5 mt-5">
         ...
         <img className="hidden md:block col-span-12 md:col-span-6 rounded-md" src="https://images.unsplash.com/photo-1490645935967-10de6ba17061?q=80&w=2053&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" 
          />
        </div>
      </div>
    )
